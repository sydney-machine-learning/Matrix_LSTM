...
PATH_TO_STORE_TRAINSET = r'D:\python\MNIST\train'    #Edit dataset folder locations
PATH_TO_STORE_TESTSET = r'D:\python\MNIST\test'
trainset = datasets.MNIST(PATH_TO_STORE_TRAINSET, download=False, train=True, transform=transform) #Set download True if not already downloaded
...
for j in range(epoch): 
    ...
    for images, labels in trainloader:
        los_t,output = update(images[:,0],labels,lr)      #images dimension (64x1x28x28). Ignore 2nd dimension
        los=los+los_t
...
plt.legend()
plt.savefig(r'D:\python\img\mnn_MNIST_accuracy.jpg') #Edit graph location